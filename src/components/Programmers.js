...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    const person = programmers.find(({id}) => id === featured) // searches through the array to find the programmer with the same id of the clicked programmer and then returns the name key value
    return person.name
  };
